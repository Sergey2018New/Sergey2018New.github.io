...
"use strict";module.exports=function(){$("#order-form").submit(function(){var e,r,o,t=$(this);e="thanks",r=t,o="order-form.php",$.ajax({url:o,type:"POST",dataType:"html",data:r.serialize(),success:function(r){result=$.parseJSON(r),$.fancybox.open({src:"#"+e,type:"inline"})},error:function(e){console.log("Ошибка. Данные не отправлены.")}})})};
...
"use strict";module.exports=function(){var e=$("[data-show-on-order]");e.hide(),$(document).on("click",".meta-make-order-button",function(){$(this);$(".choice--main.checked").length?($(".status-bar-message").removeClass("active"),e.show(),$(document).scrollTo(document.querySelector(".make-order"),1e3)):$(".status-bar-message").addClass("active")}),$(document).on("click",function(e){var t=".status-bar-message";$(".meta-make-order-button").is(e.target)||$(t).is(e.target)||0!==$(e.target).closest(".meta-make-order-button").length||0!==$(e.target).closest(t).length||$(t).removeClass("active")})};

},{}],151:[function(require,module,exports){
"use strict";require("core-js/modules/es6.array.for-each");var throttle=require("lodash/throttle");module.exports=function(){document.querySelectorAll("[data-make-sticky]").forEach(function(e){var t=document.querySelector(e.getAttribute("data-show-until-inst-visible")),i=$(e).clone();$(e.parentNode).append(i),i.addClass("fixed"),window.addEventListener("scroll",throttle(function(){var r=$(t).is(":visible"),o=document.querySelector(e.getAttribute("data-make-sticky-end")),a=e.getBoundingClientRect();if(a.top+a.height>0)i.removeClass("active");else if(o&&r){var n=o.getBoundingClientRect();n.top+n.height<window.innerHeight?i.removeClass("active"):i.addClass("active")}},50))})};
