...
"use strict";function init(){this.$=require("jquery/dist/jquery"),this.jQuery=this.$,this.tippy=require("tippy.js"),this.Macy=require("macy/dist/macy"),this.datepicker=require("./vendor/datepicker.min"),require("svg4everybody/dist/svg4everybody")(),require("retinajs/dist/retina"),require("jquery.maskedinput/src/jquery.maskedinput"),require("jquery-numerator/jquery-numerator"),require("jquery.scrollto/jquery.scrollTo.min"),require("./vendor/jquery.fancybox.min"),require("./vendor/owl.carousel.min"),$(document).ready(function(){$("input[name=phone]").mask("8 (999) 999 99 99"),require("./components/main-slider")(),require("./components/adaptive-menu")(),require("./components/make-sticky")(),require("./components/choices")(),require("./components/choices-interraction")(),require("./components/spoilers")(),require("./components/datepicker")(),require("./components/time-inputs")(),require("./components/make-order-button")(),require("./components/button-fill")(),require("./components/form-ajax.js")(),require("./components/is-mac")()})}require("core-js/modules/es6.function.bind"),init.bind(window)();
